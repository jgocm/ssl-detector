...
_sym_db.RegisterEnumDescriptor(_PROTOPOSITIONSSL_TYPEPOS)
...
_PROTOPOSITIONSSL = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='typePos', full_name='protoPositionSSL.typePos', index=3,
...
_PROTOPOSITIONSSL.fields_by_name['typePos'].enum_type = _PROTOPOSITIONSSL_TYPEPOS
_PROTOPOSITIONSSL_TYPEPOS.containing_type = _PROTOPOSITIONSSL
