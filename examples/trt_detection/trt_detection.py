...
def main():
    ...
    parser.add_argument("--width", help="Model input width", default=300, type=int)
    parser.add_argument("--height", help="Model input width", default=300, type=int)
    parser.add_argument(
        "--scoreThreshold", help="Score threshold.", default=0.7, type=float
    )
    ...
    while cap.isOpened():
        ...
        for index, box in enumerate(boxs):
            ...
            draw_caption(frame, (xmin, ymax - 5), caption)
