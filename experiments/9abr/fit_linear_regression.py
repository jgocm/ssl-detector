...
bboxes = pd.read_csv(cwd+f"/experiments/9abr/bounding_boxes.txt", sep=" ", header=None)
positions = pd.read_csv(cwd+f"/experiments/9abr/field_pixels.txt", sep=" ", header=None)
...
print(y_coef)
np.savetxt(cwd+f"/experiments/9abr/regression_weights.txt", [x_coef, y_coef])